...
class KalmanFilterNode(Node):
    ...
    def odom_callback(self, msg):
        ...
        # Calcula el vector de control u a partir de la odometría
        ...
        if self.prev_time is not None:
            ...
            dt = 0.0
        self.prev_time = curr_time  # Actualiza prev_time para la próxima llamada
    ...
    def publish_estimated_pose(self, mu, sigma):
        ...
        # Rellenar la covarianza (solo las 3 primeras variables)
        for i in range(3):
            for j in range(3):
    ...
    def publish_real_pose(self, pose):
        ...
        # Puedes dejar la covarianza en cero o ponerle un valor fijo
        self.publisher.publish(msg)
